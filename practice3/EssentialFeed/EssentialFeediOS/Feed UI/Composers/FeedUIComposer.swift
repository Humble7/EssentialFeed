...
public final class FeedUIComposer {
    ...
    public static func feedComposedWith(feedLoader: FeedLoader, imageLoader: FeedImageDataLoader) -> FeedViewController {
        ...
        let feedViewController = FeedViewController.makeWith(delegate: feedPresentationAdapter, title: FeedPresenter.title)
        
        let feedPresenter = FeedPresenter(feedView: FeedViewAdapter(controller: feedViewController, loader: MainQueueDispatchDecorator(decoratee: imageLoader)), feedLoadingView: WeakRefVirtualProxy(feedViewController))
...
private final class FeedViewAdapter: FeedView {
    ...
    func display(_ viewModel: FeedViewModel) {
        controller?.tableModel = viewModel.feed.map { model in
            ...
            let feedImagePresenter = FeedImagePresenter(view: WeakRefVirtualProxy(cellController), imageTransformer: UIImage.init)
